/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.29 on Mon May 27 20:33:40 2019.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=4.0, gles2=2.0, glsc2=2.0, gles1=1.0
